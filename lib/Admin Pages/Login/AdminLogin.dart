import 'package:asic_miner_website/Admin%20Pages/Login/Controller/AdminLoginController.dart';
        ...
        child: Column(
          children: [
            ...
            BasicButton(
              onPressed: () {
                controller.login(() {
                  SceneController.pushAndRemoveUntil(context,
                      nextPage: AdminMain());
                });
              },
              width: 132,
