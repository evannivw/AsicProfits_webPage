...
{
  TopWidget({this.viewType = ViewType.desktop_full,this.tabPageViewController});
  ViewType viewType;
...
class _TopWidget extends State<TopWidget>
{
  ...
  void addPageListener()
  {
    ...
    widget.tabPageViewController?.pageController.addListener(() {
      int page = widget.tabPageViewController?.pageController.page?.round() ?? currentTappedButton;
  ...
  Widget mobileButtons()
  {
    return Row(
      ...
      children: [
        ...
        BasicButton(
          onPressed: ()async{
            CustomDialog.makeDialog(context, SideView(tabController: widget.tabPageViewController,));
          },
          width: 36,
          height: 36,
          baseColor: DocColors.gray_2,
    ...
    return Row(
      ...
      children: [
            ...
            child: IgnorePointer(
              ...
              child: BasicButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    MediumText("Miners",color: DocColors.white,),
                    //SizedBox(width: 2,),
                    Container(
                      width: 5.82,
        ...
        BasicButton(
          ...
          onPressed: (){setTappedButton(MainPage.Hosting);}),
        SizedBox(width: 10,),
        BasicButton(
          text: "Partners",
          baseColor: getButtonColor(MainPage.Vendors.index),
          onPressed: (){setTappedButton(MainPage.Vendors);}),
        SizedBox(width: 10,),
            ...
            child: IgnorePointer(
              ...
              child: BasicButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    MediumText("Help",color: DocColors.white,),
                    //SizedBox(width: 2,),
                    Container(
                      width: 5.82,
                      alignment: Alignment.center,
