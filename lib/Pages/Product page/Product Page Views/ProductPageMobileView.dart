...
class _ProductPageMobileView extends State<ProductPageMobileView> {
              ...
              for (var hosting in hostings)
                InkWell(
                  ...
                  child: CardWidget(
                    ...
                    width: 518,
                    padding:
                        EdgeInsets.only(left: 10, right: 10, bottom: 9, top: 9),
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            MediumText(
                              hosting.status.toLowerCase().contains("enable")
                                  ? "Available"
                                  : "Sold out",
                              color: DocColors.gray,
                              fontSize: FontSizes(10),
            ...
            child: DataTable(
                ...
                columns: [
                  DataColumn(
                    ...
                    color: DocColors(Colors.white.withOpacity(0.3)),
                  )),
                  DataColumn(
                      label: MediumText(
                    "Price",
                ...
                rows: List<DataRow>.generate(_miner.whereToBuyList.length,
                    (int index) {
                  var seller = _miner.whereToBuyList[index];
  ...
  Widget specifications() {
    return Column(
      ...
      children: [
        ...
        specsText("Manufacturer", _miner.manu),
        specsText("Model", _miner.model),
        specsText("Release", _miner.release,
            color: DocColors.green, useContainer: true),
        specsText("Size", _miner.size),
        specsText("Weight", "${_miner.weight}g"),
        specsText("Noise level", "${_miner.noise}db"),
        specsText("Fan(s)", "${_miner.fans}"),
        specsText("Power", "${_miner.power}W", icon: SVGWidgets.powerIcon),
        specsText("Voltage", "${_miner.voltage}V"),
        specsText("Interface", "${_miner.interface}"),
        specsText("Temperature", "${_miner.temperature} °C",
            icon: SVGWidgets.temperatureIcon),
        specsText("Humidity", "${_miner.humidity} %"),
      ],
    );
  }
        ...
        Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                for (var coin in _miner.minableCoinList) coinWidget(coin),
              ],
            ),
          ),
        ),
  ...
  Widget coinWidget(MinableCoinModel coin,
      {double size = 41, double margin = 10}) {
    return Container(
      width: size,
      height: size,
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      MediumText(
                        _miner.hashrate + _miner.hashrateUnits,
                        fontSize: FontSizes.xs,
                      ),
                      VerticalSpacing(
                        height: 20,
  ...
  Widget gpuChartSpecs(List<Widget> widgetList,
      {DocColors borderColor = DocColors.black, double margin = 5}) {
    return CardWidget(
      height: 34,
  ...
  Widget specsText(String title, String value,
      {DocColors color = DocColors.white,
      Widget? icon,
  ...
  Widget miningPoolsWidget() {
    return Column(
      ...
      children: [
        ...
        for (var pool in _miner.miningPoolList)
          MiningPoolsCard(
            miningPool: pool,
          ),
      ],
