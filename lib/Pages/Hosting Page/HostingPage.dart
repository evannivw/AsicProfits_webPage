...
import 'package:asic_miner_website/Pages/Hosting%20Page/Controller/HostingPageController.dart';
...
class _HostingPage extends State<HostingPage> {
  int _currentPage = 0;
  HostingPageController controller = HostingPageController();
    ...
    return Column(
      ...
      children: [
        ...
        SceneController.isMobilView
            ? Column(
                children: [
                  for (var hosting in controller.hostingList)
                    hostingCard(hosting)
                ],
              )
            : Container(
  ...
  Widget hostingCard(HostingFacilitiesModel hosting) {
    return Column(
      children: [
