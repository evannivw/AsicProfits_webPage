...
class BuyingOpportunitiesWidget extends StatelessWidget
{
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        VerticalSpacing(height: SceneController.isMobilView ? 0 : 30,),
        BoldText("Buying Opportunities",
            ...
            children: [
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    BuyingOptionCard(currentMiner: MinerModel(),),
                    BuyingOptionCard(currentMiner: MinerModel(),),
                    BuyingOptionCard(currentMiner: MinerModel(),),
                    BuyingOptionCard(currentMiner: MinerModel(),),
                    BuyingOptionCard(currentMiner: MinerModel(),),
    ...
    return Container(
      ...
      child: BasicButton(
        onPressed: (){
          if(isLeft)
          {
            scrollController.animateTo(-267.5, duration: Duration(milliseconds: 100), curve: Curves.easeInOut);
          }else
          {
            scrollController.animateTo(267.5, duration: Duration(milliseconds: 100), curve: Curves.easeInOut);
          }
        ...
        child: RotatedBox(
          ...
          child: Icon(Icons.arrow_drop_down,size: 12.5,)),
      ),
    );
  }
